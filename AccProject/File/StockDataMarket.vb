...
Public Class StockDataMarket
    ...
    Private dataConpathMovement = "Movement.mdb"
    ...
    Friend Sub LoadStockData()
        ...
        Dim moveSer = New FieldMombers With {.Name = "ser", .iskey = True, .Caption = "ASDF"}
        ...
        mydatac2.Load(dataConpathMovement, stockMoveTable, StockMove)
